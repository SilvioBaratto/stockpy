...
class TestGRUForecaster:
    ...
    def test_module_has_encoder_and_decoder(self):
        ...
        assert isinstance(model.module_.encoder, nn.GRU)
    ...
    def test_callbacks_early_stopping(self):
        ...
        # With an impossibly large absolute threshold, the callback
        # should trigger after the second epoch.
