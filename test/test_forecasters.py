...
class TestForecasterStubs:
    ...
    def test_lstm_forward_does_not_raise_not_implemented(self):
        ...
        inst.module_ = LSTMModel(n_features=2, pred_len=2, rnn_size=4, hidden_size=4)
    ...
    def test_gru_forward_does_not_raise_not_implemented(self):
        ...
        inst.module_ = GRUModel(n_features=2, pred_len=2, rnn_size=4, hidden_size=4)
        out = inst.forward(torch.randn(1, 4, 2))
        assert out.shape == (1, 2, 2)
    ...
    def test_bilstm_forward_does_not_raise_not_implemented(self):
        ...
        inst.module_ = BiLSTMModel(n_features=2, pred_len=2, rnn_size=4, hidden_size=4)
        out = inst.forward(torch.randn(1, 4, 2))
        assert out.shape == (1, 2, 2)
    ...
    def test_bigru_forward_does_not_raise_not_implemented(self):
        ...
        inst.module_ = BiGRUModel(n_features=2, pred_len=2, rnn_size=4, hidden_size=4)
        out = inst.forward(torch.randn(1, 4, 2))
        assert out.shape == (1, 2, 2)
    ...
    def test_tcn_forward_does_not_raise_not_implemented(self):
        ...
        inst.module_ = TCNModel(n_features=2, pred_len=2, num_filters=4, hidden_size=4)
        out = inst.forward(torch.randn(1, 4, 2))
        assert out.shape == (1, 2, 2)

    def test_dmm_forward_does_not_raise_not_implemented(self):
        from stockpy.forecasters._dmm import DMMModel

        inst = DMMForecaster(context_len=4, pred_len=2, z_dim=8, rnn_dim=8)
        inst.module_ = DMMModel(n_features=2, pred_len=2, z_dim=8, rnn_dim=8)
        inst.module_.initialize_module(2)
        out = inst.forward(torch.randn(1, 4, 2))
        assert out.shape == (1, 2, 2)
    ...
    def test_stockpy_exports_all_forecasters(self):
        import stockpy
