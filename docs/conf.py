...
# logo
html_logo = "_static/img/stockpi_v3.png"
...
latex_documents = [
    (master_doc, 'stockpy.tex', 'stockpy Documentation',
...
man_pages = [
    (master_doc, 'stockpy', 'stockpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'stockpy', 'stockpy Documentation',
     author, 'stockpy', 'One line description of project.',
     'Miscellaneous'),
]
...
def project_linkcode_resolve(domain, info):
    ...
    return _linkcode_resolve(domain, info,
            ...
            url_fmt='https://github.com/SilvioBaratto/stockpy/'
                    'blob/{revision}/'
