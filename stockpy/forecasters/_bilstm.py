...
class BiLSTMModel(nn.Module):
    """BiLSTM-based encoder-decoder for time-series forecasting.

    The encoder is a bidirectional LSTM that processes the context window.
    The decoder is a unidirectional LSTM that autoregressively produces the
    ...
    rnn_size : int, default=32
        Hidden size of each LSTM direction in the encoder.
    ...
    bias : bool, default=True
        Use bias in LSTM and linear layers.
    """
    ...
    def _init_decoder_state(
        ...
        c = encoder_cell.view(self.num_layers, 2, batch_size, self.rnn_size)
...
class BiLSTMForecaster(EncoderDecoderForecaster):
    """BiLSTM-based encoder-decoder forecaster.

    Parameters
    ----------
    rnn_size : int, default=32
        Number of features in each LSTM hidden state direction.
    hidden_size : int, default=32
