...
class LSTMModel(nn.Module):
    """LSTM-based encoder-decoder for time-series forecasting.
    ...
    def forward(self, x: torch.Tensor, y: torch.Tensor | None = None) -> torch.Tensor:
        ...
        # hidden, cell: (num_layers, batch, rnn_size)
...
class LSTMForecaster(EncoderDecoderForecaster):
    """LSTM-based encoder-decoder forecaster.
    ...
    **kwargs
    ...
    def initialize_module(self) -> LSTMForecaster:
        """Create the LSTM encoder-decoder module and loss criterion."""
        self.module_ = LSTMModel(
