...
class QUANTILE():
    def __init__(self):
        self.predictor = QuantileRegressor()
    ...
    def fit(self, 
        ...
        self.predictor.fit(x_train[features], x_train[target])
    ...
    def predict(self,
        ...
        if plot is True:
            ...
            y_test = (x_test['Close']).values # * scaler.std() + scaler.mean() 
        ...
        return y_pred # * scaler.std() + scaler.mean()